    ...
    private void OnDrawGizmos () {
        for (float t = 0; t <= 1; t += 0.05f) {
            gizmosPosition = Mathf.Pow (1 - t, 3) * controlPoints[0].position +
                ...
                3 * (1 - t) * Mathf.Pow (t, 2) * controlPoints[3].position +
                // Mathf.Pow (t, 3) * controlPoints[4].position;
        ...
        // Gizmos.DrawLine (new Vector3 (controlPoints[3].position.x, controlPoints[3].position.y, controlPoints[3].position.z), new Vector3 (controlPoints[4].position.x, controlPoints[4].position.y, controlPoints[4].position.z));
    }
}